...
def run_experiment(hyper_choose, res_dir):
    # load data
    train_eeg, train_eye, train_label, test_eeg, test_eye, test_label = load_data()
    # run the experiment
    run_experiment_single_model(hyper_choose, res_dir, train_eeg, train_eye, train_label, test_eeg, test_eye, test_label)
